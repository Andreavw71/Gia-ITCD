				...
				<tr>
					<td width="740" align="left" valign="top">		
						<table width="740" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td height="22" width="740"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><img src="/imagens/ponto.gif" height="9" width="9"> <a href="<%=JspUtil.getContexto(request)%>giaitcd/giaitcdinventarioarrolamento/incluir?parametroTelaBloqueio=1">Inventário/Arrolamento</a></font></div></td>
                                                <td>
                           <!--                     
                           ...
                           <div class="pop-transparent"></div>
                                    ...
                                    <div id="pop-content" class="pop-content">                          
                                       <table cellspacing="1" cellpadding="0" border="0" width="740" align="center" style="margin-bottom: 15px;" >
                                             ...
                                             <tr>
                                                <td>
                                                   <p align="justify" class="texto" >
                                                      Deve-se, para os casos acima elencados, preencher em substituição à GIA ITCD  a  &ldquo;Declaração  de  ITCD&rdquo;,  Anexo  VI,  da  Portaria nº 177/2018,  realizando  o  protocolo  da  mesma através de e-process &ldquo;PROTOCOLO DE  GIA ITCD&rdquo;.   
                                                   </p>
                                                </td>
                                             </tr>
                                       </table>                      
							...
							<tr>
                        <td height="22" width="250"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><img src="/imagens/ponto.gif" height="9" width="9"> <a href="<%=JspUtil.getContexto(request)%>giaitcd/giaitcddoacao/incluir">Doação/Outros</a></font></div></td>
                     </tr>
							<tr>
                        <td height="22"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><img src="/imagens/ponto.gif" height="9" width="9"> <a href="<%=JspUtil.getContexto(request)%>giaitcd/giaitcdseparacaodivorcio/incluir?parametroTelaBloqueio=1">Separação/Divórcio/Partilha</a></font></div></td>
                        <td>
                        <!--
                           ...
                           <div class="pop-transparent"></div>
							...
							<tr>
								<td height="22"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"></font></div></td>
                        <td>
                           <!--
                                             ...
                                             <tr>
                                                <td>
                                                   <p align="justify" class="texto" >
                                                      ...
                                                      Anexo  VI,  da  Portaria nº 177/2018,  realizando  o  protocolo  da  mesma através de e-process
                                                       &ldquo;PROTOCOLO DE GIA ITCD (E  ANEXO VI DA PORTARIA nº 177/2018)&rdquo;.                                                     
                                                   </p>
                                                </td>
                                             </tr>
                                       </table>                      
