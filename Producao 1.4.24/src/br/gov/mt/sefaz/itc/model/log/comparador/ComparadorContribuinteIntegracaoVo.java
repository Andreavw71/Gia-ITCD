...
public class ComparadorContribuinteIntegracaoVo extends Comparador<ContribuinteIntegracaoVo> implements CamposContribuinteIntegracaoVo
{
   public ComparadorContribuinteIntegracaoVo()
   {
      super(TABELA_EXTERNA_CADS_PESSOA);
   }

   public ComparadorContribuinteIntegracaoVo(DomnTipoOperacao tipoOperacao)
   {
      super(TABELA_EXTERNA_CADS_PESSOA, tipoOperacao);
   }
