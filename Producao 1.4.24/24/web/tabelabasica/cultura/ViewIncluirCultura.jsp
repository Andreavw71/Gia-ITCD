...
* Arquivo : ViewIncluirCultura.jsp
                ...
                <table class="SEFAZ-TABLE-Moldura" cellspacing="1" cellpadding="0" border="0" width="740" align="center">
                    ...
                    <tr> 
                        ...
                        <td class="SEFAZ-TD-CampoEntrada"> 
                            <input name="<%=Form.CAMPO_DESCRICAO_CULTURA%>"  type="text" class="SEFAZ-INPUT-Text" size="50" maxlength="50"   onblur="toUpperCaseW3c(this);" /><font color="red">*</font>
                        </td>
                    </tr>
                    <tr> 
                        <td colspan="2">&nbsp;</td>
