...
import { GIAITCDSeparacaoDivorcio } from '../../../types';
...
const DemonstrativoCalculoSeparacao: React.FC<Props> = ({ gia, onPrevious }) => {
  return (
    <div>
      <FormSection title="Demonstrativo de Calculo">
        <div className="sefaz-data-grid">
          ...
          <div className="sefaz-td-rotulo">Valor UPF:</div>
          <div className="sefaz-td-campo-saida">{formatCurrency(gia.valorUPF)}</div>
...
export default DemonstrativoCalculoSeparacao;
